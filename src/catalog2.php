...
<section class="catalog">
    <div class="catalog__wrapper">
        <div class="catalog__first-block catalog__item wow fadeIn">
            <h3 class="catalog__block-title">Инъекционные составы</h3>
           <div class="catalog__content js-catalog__content" id="question-1">
                <div class="catalog__galery-wrapper">
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct4-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 21 P</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct2-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 81 A</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct3-min.jpg" alt="product">
                        <p class="catalog__galery-title"> METACRETE Inject 82 A</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct1-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject MC 20</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct5-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 10 P</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct6-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 11 P</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct7-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 15 P</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct8-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 41 P</p>
                    </div>
                    <div class="catalog__galery-item">
                        <img class="catalog__galery-img" src="images/injectproduct/injectproduct9-min.jpg" alt="product">
                        <p class="catalog__galery-title">METACRETE Inject 51 P</p>
                    </div>
                </div>
